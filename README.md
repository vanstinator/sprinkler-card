...
![Preview of sprinkler-card][preview-image]
...
3. Add reference to `sprinkler-card.js` in Lovelace. There's two way to do that:
   1. **Using UI:** _Configuration_ → _Lovelace Dashboards_ → _Resources_ → Click Plus button → Set _Url_ as `/local/sprinkler-card.js` → Set _Resource type_ as `JavaScript Module`.
...
- [Benji][bbbenji-card] sprinkler card — this is where I noticed this sprinkler card design for the [first time](https://github.com/bbbenji/synthwave-hass/issues/29).
...
[npm-url]: https://npmjs.org/package/sprinkler-card
[npm-image]: https://img.shields.io/npm/v/sprinkler-card.svg?style=flat-square
...
[latest-release]: https://github.com/denysdovhan/sprinkler-card/releases/latest
[ha-scripts]: https://www.home-assistant.io/docs/scripts/
[edit-readme]: https://github.com/denysdovhan/sprinkler-card/edit/master/README.md
[add-translation]: https://github.com/denysdovhan/sprinkler-card/tree/master/src/translations
